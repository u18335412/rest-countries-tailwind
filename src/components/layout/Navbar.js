...
const Navbar = (props) => {
  return (
    <>
      <section className=" dark:bg-grayishDarkBlue dark:text-white px-5 2xl:px-28  shadow-md flex text-xs md:text-base justify-between items-center justify-items-center  py-3">
        <div>
